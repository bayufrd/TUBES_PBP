...
public class TambahSapi_Panel extends HomeAfter_Panel{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        batal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TambahSapi_Panel.this, HomeAfter_Panel.class);
            ...
            public void OnClickRegister() {
                if(
                    ...
                    Call<ResponsModel> SapiDAOCALL = api.sendBiodata(namapemilik.getText().toString(),
                    ...
                    SapiDAOCALL.enqueue(new Callback<ResponsModel>() {
                        ...
                        public void onResponse(Call<ResponsModel> call, Response<ResponsModel> response) {
                            ...
                            if(kode.equals("1")){
                                Toast.makeText(TambahSapi_Panel.this, "Sapi telah ditambah :D",Toast.LENGTH_SHORT).show();
                                startIntent();
                            }else{
                                Toast.makeText(TambahSapi_Panel.this,"Sapi gagal ditambah :(",Toast.LENGTH_SHORT).show();
                            }
                        ...
                        public  void onFailure(Call<ResponsModel> call, Throwable t){
                            ...
                            Toast.makeText(TambahSapi_Panel.this,"Gagal Menambahkan data sapi :(, cek koneksi",Toast.LENGTH_SHORT).show();
                        }
